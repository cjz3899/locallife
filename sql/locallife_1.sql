...
LOCK
    TABLES `tb_blog` WRITE;
ALTER TABLE `tb_blog`
    DISABLE KEYS;
INSERT INTO `tb_blog`
VALUES (4, 4, 1987042234935279617, '无尽浪漫的夜晚丨在万花丛中摇晃着红酒杯🍷品战斧牛排🥩',
        ...
        1, 104, '2021-12-28 11:50:01', '2025-11-08 06:28:33'),
       (5, 1, 1987042234935279617, '人均30💰杭州这家港式茶餐厅我疯狂打call‼️',
       ...
       (6, 10, 1987041610793484289, '杭州周末好去处｜💰50就可以骑马啦🐎', '/imgs/blogs/blog1.jpg',
        '杭州周末好去处｜💰50就可以骑马啦🐎', 1, 0, '2022-01-11 08:05:47', '2025-11-08 06:28:37'),
       (7, 10, 1987041610793484289, '杭州周末好去处｜💰50就可以骑马啦🐎', '/imgs/blogs/blog1.jpg',
        '杭州周末好去处｜💰50就可以骑马啦🐎', 1, 0, '2022-01-11 08:05:47', '2025-11-08 06:28:37');
ALTER TABLE `tb_blog`
    ENABLE KEYS;
UNLOCK
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci
  ROW_FORMAT = COMPACT COMMENT ='Redis回滚失败日志表';
SET character_set_client = @saved_cs_client;

LOCK
    TABLES `tb_rollback_failure_log` WRITE;
ALTER TABLE `tb_rollback_failure_log`
    DISABLE KEYS;
ALTER TABLE `tb_rollback_failure_log`
    ENABLE KEYS;
UNLOCK
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci
  ROW_FORMAT = COMPACT COMMENT ='秒杀优惠券表，与优惠券是一对一关系';
SET character_set_client = @saved_cs_client;

LOCK
    TABLES `tb_seckill_voucher_0` WRITE;
ALTER TABLE `tb_seckill_voucher_0`
    DISABLE KEYS;
INSERT INTO `tb_seckill_voucher_0`
VALUES (1987043235650076673, 1, 200, 200, '1,2', 1, '2025-11-08 06:23:19', '2025-11-02 13:00:00', '2025-12-02 15:59:59',
        '2025-11-20 07:23:03');
ALTER TABLE `tb_seckill_voucher_0`
    ENABLE KEYS;
UNLOCK
...
LOCK
    TABLES `tb_seckill_voucher_1` WRITE;
ALTER TABLE `tb_seckill_voucher_1`
    DISABLE KEYS;
ALTER TABLE `tb_seckill_voucher_1`
    ENABLE KEYS;
UNLOCK
...
VALUES (1, '103茶餐厅', 1,
        ...
        '2021-12-22 10:10:39', '2022-01-13 09:32:19'),
       (2, '蔡馬洪涛烤肉·老北京铜锅涮羊肉', 1,
        ...
        '11:30-03:00', '2021-12-22 11:00:13', '2022-01-11 08:12:26'),
       (3, '新白鹿餐厅(运河上街店)', 1,
        ...
        '2021-12-22 11:10:05', '2022-01-11 08:12:42'),
       (4, 'Mamala(杭州远洋乐堤港店)', 1,
        ...
        '11:00-22:00', '2021-12-22 11:17:15', '2022-01-11 08:12:51'),
       (5, '海底捞火锅(水晶城购物中心店）', 1,
        ...
        '2021-12-22 11:20:58', '2022-01-11 08:13:01'),
       (6, '幸福里老北京涮锅（丝联店）', 1,
        ...
        '11:00-13:50,17:00-20:50', '2021-12-22 11:24:53', '2022-01-11 08:13:09'),
       (7, '炉鱼(拱墅万达广场店)', 1,
        ...
        0000001320, 47, '00:00-24:00', '2021-12-22 11:40:52', '2022-01-11 08:13:19'),
       (8, '浅草屋寿司（运河上街店）', 1,
        ...
        '2021-12-22 11:51:06', '2022-01-11 08:13:25'),
       (9, '羊老三羊蝎子牛仔排北派炭火锅(运河上街店)', 1,
        ...
        '11:00-21:30', '2021-12-22 11:53:59', '2022-01-11 08:13:34'),
       (10, '开乐迪KTV（运河上街店）', 2,
        ...
        '2021-12-22 12:25:16', '2021-12-22 12:25:16'),
       (11, 'INLOVE KTV(水晶城店)', 2,
        ...
        '2021-12-22 12:29:02', '2021-12-22 12:39:00'),
       (12, '魅(杭州远洋乐堤港店)', 2,
        ...
        '2021-12-22 12:34:34', '2021-12-22 12:34:34'),
       (13, '讴K拉量贩KTV(北城天地店)', 2,
        ...
        '12:00-02:00', '2021-12-22 12:38:54', '2021-12-22 12:40:04'),
       (14, '星聚会KTV(拱墅区万达店)', 2,
        ...
        '2021-12-22 12:48:54', '2021-12-22 12:48:54');
ALTER TABLE `tb_shop`
    ENABLE KEYS;
UNLOCK
    TABLES;
...
LOCK
    TABLES `tb_shop_type` WRITE;
ALTER TABLE `tb_shop_type`
    DISABLE KEYS;
INSERT INTO `tb_shop_type`
VALUES (1, '美食', '/types/ms.png', 1, '2021-12-22 12:17:47', '2021-12-23 03:24:31'),
       (2, 'KTV', '/types/KTV.png', 2, '2021-12-22 12:18:27', '2021-12-23 03:24:31'),
       (3, '丽人·美发', '/types/lrmf.png', 3, '2021-12-22 12:18:48', '2021-12-23 03:24:31'),
       (4, '健身运动', '/types/jsyd.png', 10, '2021-12-22 12:19:04', '2021-12-23 03:24:31'),
       (5, '按摩·足疗', '/types/amzl.png', 5, '2021-12-22 12:19:27', '2021-12-23 03:24:31'),
       (6, '美容SPA', '/types/spa.png', 6, '2021-12-22 12:19:35', '2021-12-23 03:24:31'),
       (7, '亲子游乐', '/types/qzyl.png', 7, '2021-12-22 12:19:53', '2021-12-23 03:24:31'),
       (8, '酒吧', '/types/jiuba.png', 8, '2021-12-22 12:20:02', '2021-12-23 03:24:31'),
       (9, '轰趴馆', '/types/hpg.png', 9, '2021-12-22 12:20:08', '2021-12-23 03:24:31'),
       (10, '美睫·美甲', '/types/mjmj.png', 4, '2021-12-22 12:21:46', '2021-12-23 03:24:31');
ALTER TABLE `tb_shop_type`
    ENABLE KEYS;
UNLOCK
    TABLES;
...
LOCK
    TABLES `tb_user_0` WRITE;
ALTER TABLE `tb_user_0`
    DISABLE KEYS;
INSERT INTO `tb_user_0`
VALUES (1987041610793484289, '13686869696', '', '小鱼同学', '/imgs/blogs/blog1.jpg', '2025-11-08 06:16:52',
        '2025-11-08 06:17:40'),
       (1987042234935279617, '13838411438', '', '可可今天不吃肉', '/imgs/icons/kkjtbcr.jpg', '2025-11-08 06:19:20',
        '2025-11-08 06:19:55'),
       (1987042505555968001, '13456789001', '', '可爱多', '/imgs/icons/user5-icon.png', '2025-11-08 06:20:25',
        '2025-11-08 06:20:47');
ALTER TABLE `tb_user_0`
    ENABLE KEYS;
UNLOCK
...
LOCK
    TABLES `tb_user_info_0` WRITE;
ALTER TABLE `tb_user_info_0`
    DISABLE KEYS;
INSERT INTO `tb_user_info_0`
VALUES (1987041610868981762, 1987041610793484289, '', NULL, 0, 0, 0, NULL, 0, 1, '2025-11-08 06:16:52',
        '2025-11-08 06:16:52'),
       (1987042234943668226, 1987042234935279617, '', NULL, 0, 0, 0, NULL, 0, 1, '2025-11-08 06:19:20',
        '2025-11-08 06:19:20'),
       (1987042505560162305, 1987042505555968001, '', NULL, 0, 0, 0, NULL, 0, 1, '2025-11-08 06:20:25',
        '2025-11-08 06:20:25');
ALTER TABLE `tb_user_info_0`
    ENABLE KEYS;
UNLOCK
...
LOCK
    TABLES `tb_user_info_1` WRITE;
ALTER TABLE `tb_user_info_1`
    DISABLE KEYS;
ALTER TABLE `tb_user_info_1`
    ENABLE KEYS;
UNLOCK
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='用户手机表';
SET character_set_client = @saved_cs_client;

LOCK
    TABLES `tb_user_phone_0` WRITE;
ALTER TABLE `tb_user_phone_0`
    DISABLE KEYS;
ALTER TABLE `tb_user_phone_0`
    ENABLE KEYS;
UNLOCK
...
LOCK
    TABLES `tb_user_phone_1` WRITE;
ALTER TABLE `tb_user_phone_1`
    DISABLE KEYS;
ALTER TABLE `tb_user_phone_1`
    ENABLE KEYS;
UNLOCK
...
LOCK
    TABLES `tb_voucher_0` WRITE;
ALTER TABLE `tb_voucher_0`
    DISABLE KEYS;
INSERT INTO `tb_voucher_0`
VALUES (1, 1, '80元代金券', '周一至周日均可使用', '无规则', 20, 100, 1, 1, '2025-11-08 06:23:19',
        '2025-11-20 07:23:03');
ALTER TABLE `tb_voucher_0`
    ENABLE KEYS;
UNLOCK
...
LOCK
    TABLES `tb_voucher_1` WRITE;
ALTER TABLE `tb_voucher_1`
    DISABLE KEYS;
ALTER TABLE `tb_voucher_1`
    ENABLE KEYS;
UNLOCK
...
LOCK
    TABLES `tb_voucher_order_0` WRITE;
...
LOCK
    TABLES `tb_voucher_order_1` WRITE;
...
LOCK
    TABLES `tb_voucher_order_router_0` WRITE;
ALTER TABLE `tb_voucher_order_router_0`
    DISABLE KEYS;
ALTER TABLE `tb_voucher_order_router_0`
    ENABLE KEYS;
UNLOCK
...
LOCK
    TABLES `tb_voucher_order_router_1` WRITE;
ALTER TABLE `tb_voucher_order_router_1`
    DISABLE KEYS;
ALTER TABLE `tb_voucher_order_router_1`
    ENABLE KEYS;
UNLOCK
...
LOCK
    TABLES `tb_voucher_reconcile_log_0` WRITE;
ALTER TABLE `tb_voucher_reconcile_log_0`
    DISABLE KEYS;
ALTER TABLE `tb_voucher_reconcile_log_0`
    ENABLE KEYS;
UNLOCK
...
LOCK
    TABLES `tb_voucher_reconcile_log_1` WRITE;
ALTER TABLE `tb_voucher_reconcile_log_1`
    DISABLE KEYS;
ALTER TABLE `tb_voucher_reconcile_log_1`
    ENABLE KEYS;
UNLOCK
